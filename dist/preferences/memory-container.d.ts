import { PreferencesCollectionRef, PreferencesContainer, PreferencesItem, PreferencesSetOptions } from "./interfaces";
export declare class MemoryPreferencesContainer implements PreferencesContainer {
    ...
    items(collection: string, keysOrFilter?: any): Promise<PreferencesItem<any, any>[]>;
