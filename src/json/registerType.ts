...
export function registerType(typeClass: Type & {jsonTypeName: string}, options?: {replace?: boolean});
...
export function registerType() {
    ...
    const typeName = arguments.length > 0 && typeof arguments[1] === "string" ? arguments[1] : undefined;
